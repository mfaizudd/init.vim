...
map.n("<leader>q", ":BufferClose<cr>", "[Q]uit")
map.n("<leader>h", ":noh<cr>", "No [H]ighlight")
map.n("<leader>tt", ":ToggleTerm<cr>", "[T]oggle [T]erminal")
map.n("<leader>so", ":SymbolsOutline<cr>", "[S]ymbols [O]utline")
...
map.n("<A-9>", ":BufferLast<cr>", "Go to last buffer")
map.n("<A-<>", ":BufferMovePrevious<cr>", "Move buffer left")
map.n("<A->>", ":BufferMoveNext<cr>", "Move buffer right")
